...
async def actors_directory_page(req):
    ...
    async function searchDirectory(forceRestore = false) {{
        ...
        try {{
            ...
            if (myReq !== dirReqId) {{ clearTimeout(spinTimer); return; }}
